...
import {
  AlertTriangle, RotateCcw, Home, MessageSquare,
...
export function RouteError({
  ...
  useEffect(() => {
    console.error("MindStore route error:", error);
  }, [error]);
  ...
  const desc = description || error.message || "An unexpected error occurred. Your data is safe.";

  return (
    <div className="flex items-center justify-center min-h-[50vh]">
      <div className="text-center space-y-5 px-6 max-w-md">
        <div className="w-13 h-13 rounded-2xl bg-amber-500/10 border border-amber-500/15 flex items-center justify-center mx-auto">
