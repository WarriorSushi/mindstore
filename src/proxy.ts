...
/**
 * Proxy — security headers + request validation.
 * 
 * Rate limiting is done at the route level because the edge proxy
 * should stay lightweight and avoid Node-specific dependencies.
 */
