...
import {
  ...
  Clock, Pin, BarChart3, BookOpen, FileBox,
} from "lucide-react";
                ...
                {searching ? (
                  ...
                  <div className="divide-y divide-white/[0.04]">
                    ...
                    {searchResults.map((r: any, i: number) => {
                      const typeIcons: Record<string, any> = { chatgpt: MessageCircle, file: FileText, url: Globe, text: Type, kindle: BookOpen, document: FileBox };
                      const typeColors: Record<string, string> = { chatgpt: "text-green-400 bg-green-500/10", file: "text-blue-400 bg-blue-500/10", url: "text-orange-400 bg-orange-500/10", text: "text-violet-400 bg-violet-500/10", kindle: "text-amber-400 bg-amber-500/10", document: "text-blue-400 bg-blue-500/10" };
