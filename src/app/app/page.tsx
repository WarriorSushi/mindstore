...
import {
  ...
  Clock, Pin, BarChart3, BookOpen, FileBox, PlayCircle, Bookmark,
} from "lucide-react";
                ...
                {searching ? (
                  ...
                  <div className="divide-y divide-white/[0.04]">
                    ...
                    {searchResults.map((r: any, i: number) => {
                      const typeIcons: Record<string, any> = { chatgpt: MessageCircle, file: FileText, url: Globe, text: Type, kindle: BookOpen, document: FileBox, youtube: PlayCircle, bookmark: Bookmark };
